...
const LobbyPage = (): React.ReactElement => {
  ...
  return (
    <div className=" h-screen bg-gray-900 z-10 overflow-y-scroll overflow-hidden flex flex-col justify-end items-center gap-2 relative">
      <RandomTiledBackground />

      <header className="w-full flex justify-between items-center  h-[26%] bg-black absolute top-0 left-0 z-50">
        ...
        >
          <span className="text-5xl md:text-5xl lg:text-8xl text-white p-5 font-lucky">
            KONNEKT4
          </span>
        </div>
        <div className="flex  justify-center w-[70%] h-[70%] gap-5 relative">
      ...
      {online ? (
        <div className="flex  justify-center items-center w-full  h-full  z-20 mt-52">
          {!isOneAvailableRoom && <TransitionalScreen />}
          <div
            className={` mb-5 grid grid-cols-1 sm:grid-cols-2 mt-[17rem] sm:mt-0  gap-5 border-8 border-white p-2 ${
