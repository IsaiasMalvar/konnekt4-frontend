...
const LobbyRoomCard = ({ id }: LobbyRoomCardProps): React.ReactElement => {
  ...
  return (
    <div
      className="cursor-pointer hover:scale-105 hover:z-50 backdrop-blur-xl bg-cyan-300/50  text-amber-300/80 rounded-3xl p-5 text-center flex flex-col justify-center items-center"
      onClick={() => onClick(id)}
    >
